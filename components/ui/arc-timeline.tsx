...
export interface ArcTimelineItem {
    time: ReactNode;
    image?: string; // Optional image URL for the timeline year
    steps: Array<{
        icon: ReactNode;
        content: ReactNode;
    }>;
    ...
    return (
        ...
        >
            <div
                ...
                className="absolute left-1/2 top-40 aspect-square origin-center rounded-full transition-all duration-500 ease-in-out"
            >
                                ...
                                return (
                                    <div key={`${lineIndex}-${stepIndex}`}>
                                        ...
                                        >
                                            ...
                                            {stepIndex === 0 && (
                                                <div className="absolute left-1/2 top-0 z-10 -translate-x-1/2 flex flex-col items-center">
                                                    {/* Image above the year */}
                                                    {line.image && isActive && (
                                                        <motion.div
                                                            className="relative w-40 h-24 mb-2 rounded-xl overflow-hidden shadow-lg translate-y-[calc(-100%-10px)] hover:scale-110 transition-all duration-300"
                                                    ...
                                                    {/* Year text - pushed up when image is present */}
                                                    <div
                                                        className={cn(
                                                            "whitespace-nowrap transition-all duration-300",
                                                            line.image && isActive ? "translate-y-[calc(-100%-224px)]" : "translate-y-[calc(-100%-24px)]",
                                                            isActive
